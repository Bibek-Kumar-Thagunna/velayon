            ...
            >
                <div className="max-w-7xl mx-auto px-6 py-4" suppressHydrationWarning>
                    <div className="flex items-center justify-between" suppressHydrationWarning>
                        ...
                        >
                            <div className="w-8 h-8 rounded-md border border-[#333333] flex items-center justify-center bg-[#0A0A0A] group-hover:border-emerald-500 transition-colors" suppressHydrationWarning>
                            ...
                            {navLinks.map((link) => {
                                ...
                                return (
                                    <Link
                                        key={link.href}
                                        href={link.href}
                                        className="relative text-xl font-medium border-b border-white/10 pb-4"
                                        onClick={() => setIsMobileMenuOpen(false)}
                                    >
                                        <span className={`${isActive ? 'text-white' : 'text-white/80 hover:text-white'}`}>
                                            {link.label}
                                        </span>
                                        {isActive && (
                                            <motion.div
